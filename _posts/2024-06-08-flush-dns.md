...
The difference in A and B is that B has a private endpoint defined, even though it's used for a completely different purpose. If I added a private endpoint to Storage Account B, I was able to resolve the public domain name from inside the VM. This makes sense, as is pointed out in the [docs](https://learn.microsoft.com/en-us/azure/storage/common/storage-private-endpoints#dns-changes-for-private-endpoints).
